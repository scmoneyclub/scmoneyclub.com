...
const features = [
  ...
  },
  {
    ...
    description: "Enterprise-level cold storage and multi-signature wallets ensure maximum security for your digital asset holdings with institutional protection.",
  ...
  },
  {
    ...
    description: "Immutable blockchain technology provides transparent, verifiable transactions with cryptographic security at every step of your investment journey.",
  ...
  },
  {
    ...
    description: "Advanced trading strategies and algorithmic execution optimize entry and exit points, maximizing returns while minimizing market exposure.",
  ...
  },
  {
    ...
    description: "Full compliance with international regulations and KYC/AML protocols ensures your investments meet the highest institutional standards.",
  ...
  },
  {
    ...
    description: "Access to decentralized finance protocols, staking opportunities, and yield farming strategies for sophisticated cryptocurrency investors.",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Navigate the digital asset revolution with institutional-grade cryptocurrency investments. 
            Secure custody, strategic trading, and access to the most promising blockchain opportunities.
          </p>
